...
def load_active_routing_profile(
    ...
    *,
    ...
    Args:
        routing_profile_library_path: Path to the routing profiles TOML file.
    ...
    if active_profile_name not in routing_profile_library_blueprint.profiles:
        msg = f"Active profile '{active_profile_name}' not found in profile routing library. Available profiles: {profile_names_str}"
