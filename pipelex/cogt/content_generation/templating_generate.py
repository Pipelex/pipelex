...
async def templating_gen_text(templating_assignment: TemplatingAssignment) -> str:
    ...
    if templating_assignment.source:
        templating_assignment.source = preprocess_template(template=templating_assignment.source)
        check_jinja2_parsing(templating_assignment.source)
    ...
    templated_text: str = await render_jinja2(
        ...
        template_source=templating_assignment.source,
