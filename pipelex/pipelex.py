...
from pipelex.activity_manager import ActivityManager
...
from pipelex.registry_models import PipelexRegistryModels
...
class Pipelex:
    ...
    def setup(
        ...
        func_registry.register_functions(PipelexRegistryFuncs.get_all_functions())
