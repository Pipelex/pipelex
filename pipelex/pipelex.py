    ...
    def setup(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            msg = self._get_validation_error_msg("inference backend library", validation_exc=backend_validation_exc)
            raise PipelexSetupError(msg) from backend_validation_exc
        except ModelDeckValidationError as deck_validation_exc:
            msg = self._get_validation_error_msg("model deck", validation_exc=deck_validation_exc)
