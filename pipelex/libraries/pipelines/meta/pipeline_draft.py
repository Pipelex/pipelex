...
from pipelex.core.bundle.pipelex_bundle_blueprint import PipelexBundleBlueprint as PipelexBundleBlueprintCore
...
class PipelexBundleBlueprint(PipelexBundleBlueprintCore, StructuredContent):
