...
class AttributePolisher:
    ...
    def should_truncate(cls, name: str, value: Any) -> bool:
        ...
        if (name == "base_64" and len(value) > cls.base_64_truncate_length) or (name == "url" and isinstance(value, str) and value.startswith("data:image/") and len(value) > cls.url_truncate_length):
            return True
        return False
