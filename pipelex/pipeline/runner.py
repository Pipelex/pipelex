...
class PipelexRunner(RunnerProtocol["PipeOutput"]):
    ...
    def _resolve_plx_content(self, mthds_content: str | None) -> str | None:
        """Resolve plx_content from mthds_content and bundle_uri."""
    ...
    def _resolve_execution_config(self) -> PipelineExecutionConfig:
        """Resolve execution config, falling back to the global default."""
        return self.execution_config or get_config().pipelex.pipeline_execution_config
