...
async def validate_plx(library_id: str, plx_content: str, remove_after_validation: bool = True) -> tuple[PipelexBundleBlueprint, list[PipeAbstract]]:
    ...
    Args:
        library_id: The library ID to use for validation
