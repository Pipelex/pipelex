...
symbol from it drags every interpreter package it re-exports into the runtime closure. Five vendor
...
``tests/unit/pipelex/test_runtime_layer_exceptions_aggregate_gate.py`` walks every declared package
