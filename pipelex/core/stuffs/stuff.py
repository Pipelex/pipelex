...
from pipelex.exceptions import StuffArtefactReservedFieldError, StuffContentTypeError, StuffContentValidationError, StuffError
...
{self.content.short_desc}"""
    ...
    def as_mermaid(self) -> MermaidContent:
        ...
        return self.content_as(content_type=MermaidContent)
