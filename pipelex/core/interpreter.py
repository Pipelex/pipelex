...
class PipelexInterpreter(BaseModel):
    ...
    def _serialize_pipe(pipe_blueprint: Any, domain: str) -> Dict[str, Any]:
        ...
        elif isinstance(pipe_blueprint, PipeTemplateBlueprint):
            return PipelexInterpreter._serialize_template_pipe(pipe_blueprint, domain)
    ...
    @staticmethod
    def _serialize_template_pipe(pipe: PipeTemplateBlueprint, domain: str) -> Dict[str, Any]:
        """Serialize PipeTemplate blueprint."""
        result: Dict[str, Any] = {
            "type": pipe.type,
            "definition": pipe.definition,
            "output": pipe.output,
