...
Other ideas:
pipelex build pipe "Take a photo as input, and render the opposite of the photo, don't structure anything, use only text content"
...
def build_flow_cmd(
    ...
    async def run_pipeline():
        ...
        flow = FlowFactory.make_from_bundle_spec(bundle_spec=pipelex_bundle_spec)
