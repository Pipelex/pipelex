...
def graph_render_cmd(
    ...
    Examples:
        ...
        pipelex graph render tests/data/graphs/cv_and_offer.json -o ./temp/test_outputs/
        pipelex graph render tests/data/graphs/cv_and_offer.json --reactflow -o ./temp/test_outputs/
    """
