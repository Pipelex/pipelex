domain = "agentic_builder"
description = "Agent-focused builder sequences for structured generation. Assumes drafts are pre-generated."

# No concepts defined - reuses from builder and pipe_design domains

[pipe]

# PipeBatch to detail all pipe specs from signatures
