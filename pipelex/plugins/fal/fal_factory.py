...
from pipelex.hub import get_plugin_m2
...
class FalFactory:
    ...
    def make_nb_steps_from_quality_for_flux_pro(cls, quality: Quality) -> int:
        flux_map_quality_to_steps = get_plugin_m2().plugin_configs.fal_config.flux_map_quality_to_steps
        return flux_map_quality_to_steps[quality.value]

    @classmethod
    def make_nb_steps_from_quality_for_sdxl_lightning(cls, quality: Quality) -> int:
        sdxl_lightning_map_quality_to_steps = get_plugin_m2().plugin_configs.fal_config.sdxl_lightning_map_quality_to_steps
