...
from pipelex.hub import get_plugin_manager2, get_secrets_provider
    ...
    def make_openai_client(cls, llm_platform: LLMPlatform) -> openai.AsyncClient:
        ...
        match llm_platform:
            case LLMPlatform.AZURE_OPENAI:
                azure_openai_config = get_plugin_manager2().plugin_configs.azure_openai_config
            ...
            case LLMPlatform.PERPLEXITY:
                perplexity_config = get_plugin_manager2().plugin_configs.perplexity_config
            ...
            case LLMPlatform.OPENAI:
                openai_config = get_plugin_manager2().plugin_configs.openai_config
            ...
            case LLMPlatform.VERTEXAI:
                vertexai_config = get_plugin_manager2().plugin_configs.vertexai_config
            ...
            case LLMPlatform.XAI:
                xai_config = get_plugin_manager2().plugin_configs.xai_config
            ...
            case LLMPlatform.CUSTOM_LLM:
                custom_endpoint_config = get_plugin_manager2().plugin_configs.custom_endpoint_config
