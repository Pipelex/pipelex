...
from pipelex.tools.misc.base_64_utils import load_binary_as_base64, load_binary_as_base64_async
...
class AnthropicFactory:
    ...
    async def _prep_image_for_anthropic(
        ...
        if isinstance(prompt_image, PromptImageBytes):
            ...
            image_bytes = load_binary_as_base64(prompt_image.url).decode("utf-8")
            file_type = detect_file_type_from_base64(image_bytes)
            typed_bytes_or_url = f"data:{file_type.mime};base64,{image_bytes}"
