...
class GatewayCompletionsLLMWorker(OpenAICompletionsLLMWorker):
    """OpenAI Completions LLM worker specialized for the Pipelex Gateway.

    Identical to ``OpenAICompletionsLLMWorker`` except that a transient gateway
