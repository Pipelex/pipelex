...
forward. Carrying it is all this module does: no exporter reads the mapping
yet, so do not take the field's presence as evidence that a span or an event is
