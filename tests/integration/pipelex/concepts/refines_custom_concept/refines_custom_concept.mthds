domain = "refines_custom_test"
description = "Test library for refining custom concepts"
...
# Refined concept (inherits structure, cannot add own)
[concept.VIPCustomer]
description = "A VIP customer with special privileges"
refines = "refines_custom_test.Customer"
