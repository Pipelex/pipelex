...
class TestInlineStructureConcepts:
    ...
    def test_auto_detection_structure(self):
        ...
        # Create concept from blueprint
        concept = ConceptFactory.make_from_blueprint(domain="test_domain", concept_code="TestAutoDetect", concept_blueprint=blueprint)
...
not a registered subclass of StuffContent",
    ...
    def test_multiple_inline_structures_do_not_conflict(self):
        ...
        concept1 = ConceptFactory.make_from_blueprint(domain="test_domain", concept_code="Person", concept_blueprint=blueprint1)
        ...
        concept2 = ConceptFactory.make_from_blueprint(domain="test_domain", concept_code="Product", concept_blueprint=blueprint2)
