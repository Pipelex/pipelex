...
class TestImageGeneration:
    ...
    async def test_img_gen_single_opaque(
        ...
        generated_image_resolved = await generated_content_factory.make_generated_image(raw_details=generated_image_raw_details)
    ...
    async def test_img_gen_multiple(
        ...
        generated_image_resolved_list = [
            (await generated_content_factory.make_generated_image(raw_details=generated_image_raw_details))
