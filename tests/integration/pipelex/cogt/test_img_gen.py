...
class TestImageGeneration:
    ...
    async def test_img_gen_single_opaque(
        self, img_gen_handle: str, img_gen_job_params: ImgGenJobParams, topic: str, img_gen_prompt_text: str, tmp_path: Path
    ):
        ...
        generated_image_resolved = generated_content_factory.make_generated_image(raw_details=generated_image_raw_details)
        pretty_print(generated_image_resolved, title=f"Generated image resolved for topic '{topic}'")

    @pytest.mark.parametrize(("topic", "img_gen_prompt_text"), ImageGenTestCases.IMAGE_DESC)
    async def test_img_gen_single_transparent(self, img_gen_handle: str, topic: str, img_gen_prompt_text: str, tmp_path: Path):
        img_gen_worker_async = get_img_gen_worker(img_gen_handle=img_gen_handle)
