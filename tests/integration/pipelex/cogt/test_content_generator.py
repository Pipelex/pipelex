...
class TestContentGenerator:
    ...
    async def test_make_llm_text_only(self, dummy_job_metadata: JobMetadata):
    ...
    @pytest.mark.llm
    @pytest.mark.inference
    async def test_make_object_direct(self, dummy_job_metadata: JobMetadata):
    ...
    @pytest.mark.llm
    @pytest.mark.inference
    async def test_make_object_list_direct(self, dummy_job_metadata: JobMetadata):
        llm_setting_for_object = get_model_deck().get_llm_setting(llm_choice="llm_for_testing_gen_object")
    ...
    @pytest.mark.img_gen
    @pytest.mark.inference
    async def test_make_image(self, dummy_job_metadata: JobMetadata):
        ...
        assert isinstance(image, GeneratedImageResolved)
    ...
    @pytest.mark.extract
    @pytest.mark.inference
    async def test_make_extract_pages_from_image(self, extract_handle_from_image: str, dummy_job_metadata: JobMetadata):
    ...
    @pytest.mark.extract
    @pytest.mark.inference
    async def test_make_extract_pages_from_pdf(self, extract_handle_from_pdf: str, dummy_job_metadata: JobMetadata):
        extract_output = await get_content_generator().make_extract_pages(
            job_metadata=dummy_job_metadata,
    ...
    @pytest.mark.llm
    @pytest.mark.inference
    async def test_make_llm_text_with_error(self, dummy_job_metadata: JobMetadata):
