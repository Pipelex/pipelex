...
@pytest.mark.gha_disabled  # TODO: hangs reliably in CI under pytest-xdist (passes locally and serially); root cause is concurrent PipeBatch + WorkflowEnvironment.start_local under load
