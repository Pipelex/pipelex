...
class TestPipeConditionSimple:
    async def test_direct_pipe_condition_should_fail(self, load_test_library: Callable[[list[Path]], None], dummy_job_metadata: JobMetadata):
    ...
    async def test_direct_pipe_condition_should_succeed(self, load_test_library: Callable[[list[Path]], None], dummy_job_metadata: JobMetadata):
