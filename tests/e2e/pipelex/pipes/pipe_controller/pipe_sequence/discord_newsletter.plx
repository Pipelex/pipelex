...
[concept]
DiscordChannelUpdateE2E = "A Discord channel with its messages for newsletter generation"
ChannelSummaryE2E = "A summarized Discord channel for newsletter inclusion"
HtmlNewsletterE2E = "The final newsletter content in html format with organized channel summaries"

[pipe.write_discord_newsletter_e2e]
type = "PipeSequence"
description = "Create a newsletter from Discord articles by summarizing channels and organizing content"
inputs = { discord_channel_updates = "DiscordChannelUpdateE2E[]" }
output = "HtmlNewsletterE2E"
steps = [
   { pipe = "summarize_discord_channel_update_e2e", batch_over = "discord_channel_updates", batch_as = "discord_channel_update", result = "channel_summaries" },
   { pipe = "write_weekly_summary_e2e", result = "weekly_summary" },
   { pipe = "format_html_newsletter_e2e", result = "html_newsletter" },
]


[pipe.summarize_discord_channel_update_e2e]
type = "PipeCondition"
description = "Select the appropriate summary pipe based on the channel name"
inputs = { discord_channel_update = "DiscordChannelUpdateE2E" }
output = "ChannelSummaryE2E"
expression = "discord_channel_update.name"
outcomes = { "Introduce-Yourself" = "summarize_discord_channel_update_for_new_members_e2e" }
...
[pipe.summarize_discord_channel_update_general_e2e]
type = "PipeLLM"
...
[pipe.format_html_newsletter_e2e]
type = "PipeCompose"
description = "Combine weekly and channel summaries into a complete newsletter following specific formatting requirements"
inputs = { weekly_summary = "Text", channel_summaries = "ChannelSummaryE2E" }
output = "HtmlNewsletterE2E"

[pipe.format_html_newsletter_e2e.template]
category = "html"
template = """
<!-- Weekly Summary -->
