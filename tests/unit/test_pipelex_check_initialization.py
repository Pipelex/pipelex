...
class TestPipelexCheckInitialization:
    ...
    def test_check_is_initialized_returns_true_when_all_files_exist(self, tmp_path: Path, mocker: MockerFixture) -> None:
        ...
        # Mock init_config to return 0 (indicating all config files exist)
        mocker.patch("pipelex.system.configuration.config_check.init_config", return_value=0)
    ...
    def test_check_is_initialized_returns_false_when_all_files_missing(self, tmp_path: Path, mocker: MockerFixture) -> None:
        ...
        # Mock init_config to return 1 (indicating config files are missing)
        mocker.patch("pipelex.system.configuration.config_check.init_config", return_value=1)
