...
class TestIsMultiplicityCompatible:
    ...
    def test_multiplicity_compatibility(
        ...
        result = is_multiplicity_compatible(source_multiplicity=source_multiplicity, target_multiplicity=target_multiplicity)
    ...
    def test_false_is_not_compatible_with_variable_list(self):
        ...
        assert is_multiplicity_compatible(source_multiplicity=False, target_multiplicity=True) is False
    ...
    def test_false_is_compatible_with_none(self):
        ...
        assert is_multiplicity_compatible(source_multiplicity=False, target_multiplicity=None) is False
