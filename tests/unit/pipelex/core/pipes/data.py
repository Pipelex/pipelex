...
OUTPUT_MULTIPLICITY_TO_APPLY_TEST_CASES: list[
    ...
    (
        None,
        None,
        OutputMultiplicityResolution(resolved_multiplicity=None, enable_multiple_outputs=False, specific_output_count=None),
        "base=None, override=None",
    ),
    (
        True,
        None,
        OutputMultiplicityResolution(resolved_multiplicity=True, enable_multiple_outputs=True, specific_output_count=None),
        "base=True, override=None",
    ),
    (
        False,
        None,
        OutputMultiplicityResolution(resolved_multiplicity=False, enable_multiple_outputs=False, specific_output_count=None),
        "base=False, override=None",
    ),
    (3, None, OutputMultiplicityResolution(resolved_multiplicity=3, enable_multiple_outputs=True, specific_output_count=3), "base=3, override=None"),
    (5, None, OutputMultiplicityResolution(resolved_multiplicity=5, enable_multiple_outputs=True, specific_output_count=5), "base=5, override=None"),
    ...
    (
        None,
        True,
        OutputMultiplicityResolution(resolved_multiplicity=None, enable_multiple_outputs=True, specific_output_count=None),
    ...
    (
        3,
        True,
        OutputMultiplicityResolution(resolved_multiplicity=3, enable_multiple_outputs=True, specific_output_count=3),
        "base=3, override=True - preserve base count",
    ),
    (
        7,
        True,
        OutputMultiplicityResolution(resolved_multiplicity=7, enable_multiple_outputs=True, specific_output_count=7),
        "base=7, override=True - preserve base count",
    ),
    # Override is int - use override count, enable multiple outputs
    (None, 2, OutputMultiplicityResolution(resolved_multiplicity=2, enable_multiple_outputs=True, specific_output_count=2), "base=None, override=2"),
    (True, 4, OutputMultiplicityResolution(resolved_multiplicity=4, enable_multiple_outputs=True, specific_output_count=4), "base=True, override=4"),
    (
        False,
        6,
        OutputMultiplicityResolution(resolved_multiplicity=6, enable_multiple_outputs=True, specific_output_count=6),
        "base=False, override=6",
    ),
    (
        3,
        8,
        OutputMultiplicityResolution(resolved_multiplicity=8, enable_multiple_outputs=True, specific_output_count=8),
        "base=3, override=8 - override takes precedence",
    ),
    (
        5,
        1,
        OutputMultiplicityResolution(resolved_multiplicity=1, enable_multiple_outputs=True, specific_output_count=1),
    ...
    (3, -2, OutputMultiplicityResolution(resolved_multiplicity=-2, enable_multiple_outputs=True, specific_output_count=-2), "base=3, override=-2"),
    # Edge cases with zero
    (0, None, OutputMultiplicityResolution(resolved_multiplicity=0, enable_multiple_outputs=True, specific_output_count=0), "base=0, override=None"),
    (True, 0, OutputMultiplicityResolution(resolved_multiplicity=0, enable_multiple_outputs=True, specific_output_count=0), "base=True, override=0"),
    # Large numbers
    (
        1000,
        None,
        OutputMultiplicityResolution(resolved_multiplicity=1000, enable_multiple_outputs=True, specific_output_count=1000),
        "base=1000, override=None",
    ),
    (
        100,
        999,
        OutputMultiplicityResolution(resolved_multiplicity=999, enable_multiple_outputs=True, specific_output_count=999),
