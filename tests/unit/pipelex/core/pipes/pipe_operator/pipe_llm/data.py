...
class PipeLLMInputTestCases:
    ...
    VALID_TEXT_INPUT: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Process this text: @user_text",
        ),
    )
    ...
    VALID_IMAGE_INPUT: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Describe this image: @user_image",
        ),
    )
    ...
    VALID_TWO_INPUTS: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Compare @text_input with @another_text",
        ),
    )
    ...
    VALID_TEXT_AND_IMAGE: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Analyze this text: @user_text with the image: @user_image",
        ),
    )
    ...
    VALID_IMAGE_MENTIONED_IN_PROMPT: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            inputs={"user_image": "native.Image"},
            output="native.Text",
            user_prompt="Describe @user_image",
        ),
    )
    ...
    VALID_TEXT_AND_IMAGE_BOTH_IN_PROMPT: ClassVar[tuple[str, PipeLLMBlueprint]] = (
        ...
        PipeLLMBlueprint(
            ...
            inputs={"user_text": "native.Text", "user_image": "native.Image"},
            output="native.Text",
            user_prompt="Analyze @user_text and describe @user_image",
        ),
    )
    ...
    ERROR_EXTRANEOUS_INPUT: ClassVar[tuple[str, PipeLLMBlueprint, str]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Process this: @user_text",
        ),
        "extraneous_input",
    )
    ...
    ERROR_TWO_INPUTS_THREE_VARIABLES: ClassVar[tuple[str, PipeLLMBlueprint, str]] = (
        ...
        PipeLLMBlueprint(
            ...
            output="native.Text",
            user_prompt="Process @input_one, @input_two, and @input_three",
        ),
        "missing_input_variable",
    )
