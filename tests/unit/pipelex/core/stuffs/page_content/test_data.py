...
class TestData:
    ...
    EXPECTED_RENDERED_HTML = (
        "<table ><tr><th>text_and_images</th><td><table ><tr><th>text</th><td><table ><tr><th>text</th><td>"
        "Page content text</td></tr></table></td></tr><tr><th>images</th><td>None</td></tr></table></td></tr>"
        "<tr><th>page_view</th><td>None</td></tr></table>"
    )
