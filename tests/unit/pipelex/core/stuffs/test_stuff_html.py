"""Unit tests for stuff_html module."""

import pytest

from pipelex.core.stuffs.stuff_html import (
    _get_html_tab_label,  # noqa: PLC2701  # pyright: ignore[reportPrivateUsage]
    render_stuff_content_html,
    render_stuff_html,
)
...
from tests.unit.pipelex.core.stuffs.data import StuffHtmlTestData
...
class TestGetHtmlTabLabel:
    ...
    @pytest.mark.parametrize(
        ...
        StuffHtmlTestData.TAB_LABEL_CASES,
    )
...
class TestRenderStuffContentHtml:
    """Tests for render_stuff_content_html function."""
    ...
    async def test_renders_basic_content(self) -> None:
        ...
        html = await render_stuff_content_html(
...
@pytest.mark.asyncio(loop_scope="class")
class TestRenderStuffHtml:
    """Tests for render_stuff_html function."""
    ...
    async def test_renders_text_content(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_text_stuff()
    ...
    async def test_renders_html_content(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_html_stuff()
    ...
    async def test_renders_image_content_with_image_tab_label(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_image_stuff()
    ...
    async def test_renders_pdf_content_with_pdf_tab_label(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_pdf_stuff()
    ...
    async def test_renders_mermaid_content(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_mermaid_stuff()
    ...
    async def test_custom_title_overrides_stuff_title(self) -> None:
        ...
        html = await render_stuff_html(stuff, title=custom_title)
    ...
    async def test_custom_subtitle_overrides_default(self) -> None:
        ...
        html = await render_stuff_html(stuff, subtitle=custom_subtitle)
    ...
    async def test_special_characters_are_escaped(self) -> None:
        ...
        stuff = StuffHtmlTestData.make_special_chars_stuff()
