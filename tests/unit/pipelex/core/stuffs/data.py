...
def get_test_cases() -> list[tuple[str, StuffContentOrData, str | None, str, Stuff]]:
    """Generate test cases for StuffFactory implicit memory tests."""
    return [
...
def get_search_domain_test_cases() -> list[tuple[str, StuffContentOrData, str | None, str, list[str], Stuff]]:
    """Generate test cases with search_domains for StuffFactory tests."""
    return [
...
def get_error_test_cases() -> list[tuple[str, StuffContentOrData, str | None, str, list[str] | None, type[Exception], str]]:
    """Generate error test cases for StuffFactory tests."""
