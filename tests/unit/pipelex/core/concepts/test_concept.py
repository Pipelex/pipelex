...
class TestConcept:
    ...
    def test_are_concept_compatible(self):
        ...
        assert Concept.are_concept_compatible(concept_7, concept_2=concept_6, strict=True) is False
        assert Concept.are_concept_compatible(concept_7, concept_2=concept_6, strict=False) is False

        # Test same code and domain
        assert Concept.are_concept_compatible(concept1, concept_2=concept2) is True

        # Test different code and domain
        assert Concept.are_concept_compatible(concept1, concept_2=concept3) is True

        # Test same structure class name
        assert Concept.are_concept_compatible(concept1, concept_2=concept4) is False

        # Test same refines
        assert Concept.are_concept_compatible(concept_5, concept_2=concept_6, strict=False) is True
        assert Concept.are_concept_compatible(concept_5, concept_2=concept_6, strict=True) is False
    ...
    def test_concept_refining_text_is_strictly_compatible(self):
        ...
        assert Concept.are_concept_compatible(concept_not_native_text, concept_2=text_concept, strict=True) is True
        assert Concept.are_concept_compatible(concept_not_native_text, concept_2=text_concept, strict=False) is True
    ...
    def test_concept_with_same_structure_as_text_content(self):
        ...
        assert Concept.are_concept_compatible(custom_text_like_concept, concept_2=native_text_concept, strict=True) is True
        assert Concept.are_concept_compatible(custom_text_like_concept, concept_2=native_text_concept, strict=False) is True
    ...
    def test_nested_image_content_strict_false_nonstrict_true(self):
        ...
        assert Concept.are_concept_compatible(concept_with_nested_image, concept_2=concept_image_like, strict=True) is False
        # strict=False should be True: DocumentWithNestedImage has a field (metadata) that is NestedImageInfo
        assert Concept.are_concept_compatible(concept_with_nested_image, concept_2=concept_image_like, strict=False) is True
        ...
        assert Concept.are_concept_compatible(concept_image_like, concept_2=native_image_concept, strict=True) is True
        assert Concept.are_concept_compatible(concept_image_like, concept_2=native_image_concept, strict=False) is True
        ...
        assert Concept.are_concept_compatible(concept_with_nested_image, concept_2=native_image_concept, strict=True) is False
        ...
        assert Concept.are_concept_compatible(concept_with_nested_image, concept_2=native_image_concept, strict=False) is True
