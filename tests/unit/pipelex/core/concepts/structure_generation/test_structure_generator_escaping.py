...
class TestStructureGeneratorEscaping:
    ...
    def test_escape_double_quotes_in_description(self):
        ...
        generated_code, generated_class = generator.generate_from_structure_blueprint("Animal", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_single_quotes_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("TestClass", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_mixed_quotes_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("Message", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_backslashes_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("FilePath", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_newlines_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("MultiLine", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_tabs_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("Columns", structure_blueprint=blueprint)
...
and more!"""
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("ComplexType", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_default_value_with_quotes(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("WithDefault", structure_blueprint=blueprint)
...
'''
    ...
    def test_escape_default_value_with_backslashes(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("DefaultPath", structure_blueprint=blueprint)
...
'''
    ...
    def test_empty_string_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("EmptyDesc", structure_blueprint=blueprint)
...
'''
    ...
    def test_very_long_description_with_quotes(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("LongDesc", structure_blueprint=blueprint)
...
'''
    ...
    def test_unicode_characters_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("UnicodeTest", structure_blueprint=blueprint)
...
'''
    ...
    def test_carriage_return_in_description(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("CRLF", structure_blueprint=blueprint)
...
'''
    ...
    def test_multiple_fields_with_various_escaping_needs(self):
        ...
        generator = StructureGenerator()
        generated_code, generated_class = generator.generate_from_structure_blueprint("AnimalRecord", structure_blueprint=blueprint)
