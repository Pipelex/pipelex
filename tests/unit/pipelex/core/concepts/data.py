...
class TestData:
    ...
    SAMPLE_IMAGE: ClassVar[ImageContent] = ImageContent(url="https://example.com/photo.jpg")
    ...
    LOGO_IMAGE: ClassVar[ImageContent] = ImageContent(url="https://example.com/logo.png")
