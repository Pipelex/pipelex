...
class TestAgentCliFactorySuppression:
    ...
    def _restore_globals(self):
        """Save and restore PrettyPrinter.mode and root log level around each test."""
    ...
    def test_sets_warning_log_level(self, mocker: MockerFixture) -> None:
        ...
        assert root_logger.level == LogLevel.WARNING.int_logging_level
    ...
    def test_sets_custom_log_level(self, mocker: MockerFixture) -> None:
        ...
        assert root_logger.level == LogLevel.DEBUG.int_logging_level
