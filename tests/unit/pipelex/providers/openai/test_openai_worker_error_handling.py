...
from tests.unit.pipelex.providers.openai.test_data import OpenAIErrorHandlingTestData
...
def _make_img_gen_worker(mocker: MockerFixture) -> OpenAIImgGenWorker:
    ...
    mocker.patch(
        "pipelex.providers.openai.openai_img_gen_worker.ImgGenArgsFactory.make_args_for_model",
