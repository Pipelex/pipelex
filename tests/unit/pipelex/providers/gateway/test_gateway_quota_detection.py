...
from pipelex.providers.gateway.gateway_extract_worker import GatewayExtractWorker
...
class TestGatewayQuotaDetection:
    ...
    async def test_extract_worker_propagates_quota_as_capacity(self, mocker: MockerFixture) -> None:
        ...
        mocker.patch(
            "pipelex.providers.gateway.gateway_extract_worker.make_base64_url_from_any_uri",
            new_callable=mocker.AsyncMock,
        ...
        mocker.patch(
            "pipelex.providers.gateway.gateway_extract_worker.get_storage_provider",
        )
