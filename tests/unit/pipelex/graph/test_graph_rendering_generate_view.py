...
class TestGenerateViewForBundle:
    ...
    def _setup_mocks(
        ...
        return bundle_path, graph_spec_mock
    ...
    async def test_returns_graphspec_json_dump(
        ...
        bundle_path, graph_spec_mock = self._setup_mocks(mocker, tmp_path, config_layout_direction=None)
    ...
    async def test_direction_precedence(
        ...
        bundle_path, _graph_spec_mock = self._setup_mocks(mocker, tmp_path, config_layout_direction=config_layout_direction)
