...
class TestReadPySources:
    ...
    def test_captures_nested_sources_without_importing(self, tmp_path: Path):
        """Nested .py files are captured by POSIX relpath, and no file is imported.
        ...
        # No import happened: importing either fixture file would have raised on its phantom import,
        # and the phantom module names are absent from sys.modules.
