...
class TestTemplateRegistry:
    ...
    def test_register_and_get(self) -> None:
        ...
        TemplateRegistry.register(key=template_key, template_source=template_content)
    ...
    def test_keys(self) -> None:
        ...
        TemplateRegistry.register(key="key1", template_source="content1")
        TemplateRegistry.register(key="key2", template_source="content2")
        TemplateRegistry.register(key="key3", template_source="content3")
    ...
    def test_get_dict_loader(self) -> None:
        ...
        TemplateRegistry.register(key="base.html", template_source="<html>{% block content %}{% endblock %}</html>")
        TemplateRegistry.register(key="child.html", template_source="{% extends 'base.html' %}{% block content %}Hello{% endblock %}")
    ...
    def test_dict_loader_supports_includes(self) -> None:
        ...
        # Register templates
        TemplateRegistry.register(key="_partial.html", template_source="<div>Partial content</div>")
        TemplateRegistry.register(key="main.html", template_source="<html>{% include '_partial.html' %}</html>")
    ...
    def test_overwrite_existing_template(self) -> None:
        ...
        TemplateRegistry.register(key=template_key, template_source="original content")
        assert TemplateRegistry.get(template_key) == "original content"

        TemplateRegistry.register(key=template_key, template_source="new content")
