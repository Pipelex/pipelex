...
> **Checkpoint A — source paths in registries.** Stop here once direct and event-assembled graph paths preserve `source`, sourceless graphs still work, and targeted tests pass. Update this checkpoint with exact tests run and any edge-case decisions, especially cross-package dependency behavior.
