...
- **Split out the remaining work.** The runtime code-fix follow-ups the tidy surfaced live in [`wip/post-tidy-code-fixes.md`](wip/post-tidy-code-fixes.md); the consolidated deferred backlog and its evidence live in `DEFERRED-BACKLOG.md` and `BUG-VERIFICATION.md`.
