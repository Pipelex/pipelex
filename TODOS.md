...
- **Current phase:** Phase 1 COMPLETE (checkpoint C1 passed 2026-08-11). Next session starts at Phase 2.
- **Last completed item:** C1 — the qualification pass extracted to `pipelex/libraries/crate_qualification.py`, `normalize_crate` rewired, output equivalence checked differentially against HEAD and mutation-checked. No rule change; **one behavior delta**, error precedence between two independent defects (detailed in Phase 1 below).
