...
- **Pending sign-offs (the current critical path):** ① push approval for the four feature branches (unblocks the platform pin bump, CI, and PRs) — STILL OPEN; ② ~~Checkpoint 4 CMK key policy + task-role split~~ — **SIGNED OFF 2026-07-03** (both recommendations confirmed; committed code unchanged); ③ Q6 hosted-adapter location — before Phase 2b; ④ Q2 launch posture — Checkpoint 5.
