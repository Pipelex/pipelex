...
gha-tests: env
	...
	$(VENV_PYTEST) -n auto --max-worker-restart=0 --timeout=180 --timeout-method=thread -v --tb=short -m "(dry_runnable or not inference) and not (gha_disabled or pipelex_api)" || [ $$? = 5 ]
