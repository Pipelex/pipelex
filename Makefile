...
gha-tests: env
	...
	$(VENV_PYTEST) -n auto --dist=loadgroup --max-worker-restart=2 --timeout=180 --timeout-method=thread --tb=short -m "(dry_runnable or not inference) and not (gha_disabled or pipelex_api)" || [ $$? = 5 ]
