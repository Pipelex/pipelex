...
1. Configure a secret provider in your project using the `SecretsProviderProtocol`: See more in the [Secrets](../Dependency%20Injection/secrets-provider-injection.md) documentation.
...
For detailed information about dependency injection, including examples and best practices, see the [Dependency Injection](../Dependency%20Injection/dependency-injection.md) documentation.
