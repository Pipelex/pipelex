...
1. Configure a secret provider in your project using the `SecretsProviderProtocol`: See more in the [Secrets](../Secrets/secrets.md) documentation.
...
For detailed information about dependency injection, including examples and best practices, see the [Dependency Injection](../Architecture/dependency-injection.md) documentation.

## Related Topics

- [Secret Management](../Secrets/secrets.md)
