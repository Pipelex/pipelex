...
- [archive-todos-api-readiness-2.md](archive-todos-api-readiness-2.md) — the `feature/API-readiness-2` ledger (PRs #931 + #933): post-#931 `/review` follow-ups, the `*_exceptions.py` structural refactor, and the in-repo finalization of the error-handling overhaul.
