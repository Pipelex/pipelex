...
1. The **implementation plan for YesNo core** (still to write — YesNo holds the train).
2. Or, if implementing directly: execute `datetime-implementation-plan.md` phase by phase (checkboxes + checkpoints inside).
