...
1. ~~Execute `yesno-implementation-plan.md`~~ — **done.** YesNo is committed on `feature/Smart-inputs` (not pushed).
2. Execute `datetime-implementation-plan.md` phase by phase (checkboxes + checkpoints inside).
