...
Implements the design in [`wip/img-gen-size/design.md`](design.md). The design decisions are **settled** (with Louis, 2026-07-02) — do not re-litigate them; if implementation reveals a genuine conflict with the design, stop and surface it instead of silently deviating.
