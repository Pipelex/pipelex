...
| 2.3 kernel cannot build an `ImgGenPrompt` | Fixed | `7279effbd` + arm `2643b137c` on `refactor/Kernel-phase2` (#1082); doc review `5af77589b` (#1083) |
