...
- No `temporal_dynamodb` round-trip and no NDJSON files for the graph — the trace events live and die in memory inside the activity, just long enough to assemble the `GraphSpec`.
