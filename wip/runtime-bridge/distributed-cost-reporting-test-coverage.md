...
- `docs/.../tracing-cost-reporting.md` (R2 documentation) and the [`wip/history/registry/cost-report-deferred-decisions.md`](../history/registry/cost-report-deferred-decisions.md) deferred items (e.g. `tracing_config.is_enabled=false` + `--costs` -> silent no-report).
