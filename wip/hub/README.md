...
| [`pr-1062-review-followups.md`](pr-1062-review-followups.md) | **Pending work — start here.** The executable follow-up plan from the full `/review` pass on PR #1062: the transitive hole in the layer rule, the in-PR fixes, the test hardening, and the additions the release-gated sweep is missing. Nothing in it is applied; the PR is green as it stands. |
