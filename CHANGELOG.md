...
- Updated `PipeBatch`, `PipeCondition`, `PipeParallel`, `PipeSequence`, `PipeFunc`, `PipeImgGen`, `PipeTemplate`, `PipeLLM`, and `PipeOcr` classes to use `InputRequirement` for input handling.
