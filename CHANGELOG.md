...
- **`pipelex login` is gone (Breaking)**: it wrote a `PIPELEX_GATEWAY_API_KEY` that nothing reads any more. The credential flow for the hosted service is rebuilt separately.
