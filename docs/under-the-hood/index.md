...
- **The Method Kernel** - Operator semantics as importable functions, and how to call them without a loaded method
...
- [:material-engine-outline: The Method Kernel](./method-kernel.md){ .md-button }
