...
- **The Pipelex Kernel** - Operator semantics as importable functions, and how to call them without a loaded method
...
- [:material-engine-outline: The Pipelex Kernel](./pipelex-kernel.md){ .md-button }
