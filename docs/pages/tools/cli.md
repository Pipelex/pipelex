...
1. Always run `pipelex validate all -c ./pipelex_libraries` after making changes to your configuration or pipelines
...
3. When initializing a new project:
   ...
   - Finally, validate your setup with `pipelex validate all -c ./pipelex_libraries`
