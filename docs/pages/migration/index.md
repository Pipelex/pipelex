...
2. **Update concept definitions**: Change `Concept =` to `definition =` in all `[concepts.ConceptName]` sections
...
2. **Update pipe definitions**: 
   - Find all `[pipes.pipe_name]` sections
