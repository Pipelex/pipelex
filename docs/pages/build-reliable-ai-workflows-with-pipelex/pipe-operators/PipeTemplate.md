...
| `template_name`   | string          | The name of a pre-loaded template file.                                                                   | Yes (or `template`)           |
| `template`        | string          | An inline Jinja2 template string.                                                                         | Yes (or `template_name`)      |
...
template_name = "weekly_report.md"
