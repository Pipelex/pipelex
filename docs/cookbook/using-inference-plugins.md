---
title: "Using Inference Plugins Example"
description: "Install a Pipelex inference-backend plugin, watch discovery register it, and run a method against the model it serves — no API key needed."
---
