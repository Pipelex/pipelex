...
This pipeline is a simple LLM call without any input, with the provided prompt and will output a `TextContent` object. See more about native concepts [here](../building-methods/concepts/define_your_concepts.md)
...
Let's create a rigorously structured `Character` object instead of plain text. We need to create the concept `Character`. The concept names MUST be in PascalCase. [Learn more about defining concepts](../building-methods/concepts/define_your_concepts.md)
...
Learn more in [Inline Structures](../building-methods/concepts/inline-structures.md) or [Python StructuredContent Classes](../building-methods/concepts/python-classes.md).
...
!!! tip "Template Syntax"
    Our template syntax is based on [Jinja2](https://jinja.palletsprojects.com/en/stable/). Use `@` prefix for tagging a variable in the prompt. Learn more about prompting with Pipelex in the [PipeLLM documentation](../building-methods/pipes/pipe-operators/PipeLLM.md). 
...
Learn more about Jinja in the [PipeLLM documentation](../building-methods/pipes/pipe-operators/PipeLLM.md).
...
- [LLM Configuration: play with the models](../building-methods/configure-ai-llm-to-optimize-methods.md) - Optimize cost and quality
- [Full configuration of the PipeLLM](../building-methods/pipes/pipe-operators/PipeLLM.md)

**Learn more about Pipelex (domains, project structure, best practices...)**

- [Build Reliable AI Methods](../building-methods/kick-off-a-methods-project.md) - Deep dive into pipeline design
- [Cookbook Examples](../cookbook/index.md) - Real-world examples and patterns

**Learn More about the other pipes** 

- [Pipe Operators](../building-methods/pipes/pipe-operators/index.md) - PipeLLM, PipeExtract, PipeCompose, and more
- [Pipe Controllers](../building-methods/pipes/pipe-controllers/index.md) - PipeSequence, PipeParallel, PipeBatch, PipeCondition

**Explore Tools:**

- [Claude Code Skills Plugin](../features/claude-code-skills-plugin.md) - Generate pipelines from natural language
- [CLI Commands](../tools/cli/index.md) - Command-line interface reference
