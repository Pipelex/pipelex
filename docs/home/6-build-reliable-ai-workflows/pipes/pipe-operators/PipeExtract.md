...
| `model`                       | string  | The Extract model choice by name, setting, or preset to use (e.g., `"mistral-ocr"`, `"extract-all-from-document"`). Defaults to the model specified in the global config. | No       |
