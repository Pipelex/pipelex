...
See the [Pkg Lock CLI reference](../9-tools/cli/pkg.md#pkg-lock) for details.
...
See the [Pkg Install CLI reference](../9-tools/cli/pkg.md#pkg-install) for details.
...
See the [Pkg Update CLI reference](../9-tools/cli/pkg.md#pkg-update) for details.
