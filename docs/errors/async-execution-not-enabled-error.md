---
title: "Async execution not enabled"
description: "Reference for the `AsyncExecutionNotEnabledError` Pipelex error class."
---
...
| Field | Value |
|---|---|
| `error_type` | `AsyncExecutionNotEnabledError` |
| `title` | Async execution not enabled |
| `type_uri` | `https://docs.pipelex.com/latest/errors/async-execution-not-enabled-error/` |
| `error_domain` | `config` |
